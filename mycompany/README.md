...
Static company website for a senior-led IT solutions business.
...
- `script.js` contains the general site behavior such as navigation and reveals.
...
- `contact/`, `faq/`, `privacy/`, and `showcase/` are the subpages.
