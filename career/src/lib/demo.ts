...
export const demoProfile: UserProfile = {
  ...
  interests: ["Leadership roles", "International teams", "Interview preparation"],
  keywords: ["Product", "Leadership", "Career transition"],
  goals: "Търся консултант, с когото да подредя CV, LinkedIn и следващите си интервюта.",
